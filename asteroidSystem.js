class AsteroidSystem {
  ...
  constructor() {
    ...
    this.accelerations = [];
    this.diams = [];
    // initial threshold to determine asteroid spawn rate
  ...
  spawn() {
    if (random(1) < this.asteroidSpawnRate) {
      ...
      // asteroid spawn interval increases with time
      this.asteroidSpawnRate += 0.001;
    }
  }
